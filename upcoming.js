...
jQuery(function() {
    $.ajax({
        url: '/api/animeUC', // Updated URL to relative path
        type: 'GET',
        success: function(response) {
            console.log('Success:', response); // Log the response to the console
            
            // Create the table headers
            var tableHeaders = '<tr><th>Poster</th><th>Name</th><th>Description</th><th>releaseDate</th></tr>';
            ...
            response.forEach(function(anime) {
                ...
                tableRow.append('<td>' + anime.releaseDate + '</td>');
