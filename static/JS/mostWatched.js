...
jQuery(function() {
    $.ajax({
        url: '/api/animeMW', // Updated URL to relative path
        type: 'GET',
        success: function(response) {
            console.log('Success:', response); // Log the response to the console
            
            // Create the table headers
            var tableHeaders = '<tr><th>Poster</th><th>Name</th><th>Description</th><th>Views</th></tr>';
            ...
            response.forEach(function(anime) {
                ...
                tableRow.append('<td>' + anime.views + '</td>');
